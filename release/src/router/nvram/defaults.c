...
//!	{ "lan_ifnames",		""				},	// Enslaved LAN interfaces
	...
	{ "lan_proto",			"dhcp"   			},	// DHCP server [static|dhcp]  //start with DISABLED dhcp if nvram corrupted
	...
	{ "easytomato_saved_encrypt_type",	"wpa2_personal"		        }, //sets default encryption to WPA2
